...
final class ViewController: UIViewController {
    ...
    private let animator = UIViewPropertyAnimator(duration: 1.0, timingParameters: UICubicTimingParameters())
...
extension ViewController {
    private enum LayoutConstants {
        static let animatedViewSize: CGSize = .init(width: 50, height: 50)
    ...
    private func setupAnimatedView() {
        ...
        NSLayoutConstraint.activate([
            leadingConstraint,
            animatedView.topAnchor.constraint(equalTo: view.layoutMarginsGuide.topAnchor, constant: 20),
    ...
    private func setupSlider() {
        ...
        NSLayoutConstraint.activate([
            ...
            slider.topAnchor.constraint(equalTo: animatedView.bottomAnchor, constant: LayoutConstants.sliderTopPadding)
        ])
    }
}
